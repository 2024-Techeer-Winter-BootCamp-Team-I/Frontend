...
const GitRepository = () => {
  ...
  return (
    <div className="flex items-center justify-center pt-14">
      <div>
        {/* 제목 텍스트 */}
        <div className="absolute left-[25rem] font-semibold mt-[6rem] break-words font-sans text-[1.3rem] font-[100rem] text-white">
          깃허브에 업로드하기
        </div>
        ...
        <div className="flex items-center space-x-[0.2rem] ">
          {/* GitHub 아이콘 섹션 */}
          <div className="flex h-[8rem] w-[8rem] mt-[9rem] items-center justify-center">
            <img src={GithubIcon} alt="GitHub Logo" className="h-full w-full mr-[3rem]" />
          </div>

          {/* 메인 컴포넌트 */}
          <div className="flex h-[12rem] w-[55rem] mt-[9rem] rounded-[0.75rem] bg-[#212227]">
            {/* 왼쪽 섹션 */}
            ...
            <div className="flex w-[40.4375rem] flex-col justify-center space-y-[1rem] pl-[2.3rem]">
              ...
              <div className="flex items-center space-x-[0.9rem]">
                ...
                <h3 className="text-[1rem] text-white font-medium">Private</h3>
              </div>
