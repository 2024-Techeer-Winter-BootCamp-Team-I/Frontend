  ...
  <div>
    ...
    <div className="sb-container">
      <div className="sb-section-title">
        # Configure your project Because Storybook works separately from your
        app, you will need to configure it for your specific stack and setup.
        Below, explore guides for configuring Storybook with popular frameworks
        and tools. If you get stuck, learn how you can ask for help from our
        community.
      </div>
      <div className="sb-section">
        ...
        <div className="sb-section-item">
          ...
          <p className="sb-section-item-paragraph">
            Often when a story doesnt render, its because your component is
            expecting a specific environment or context (like a theme provider)
            to be available.
          </p>
          <a
    ...
    <div className="sb-container">
      <div className="sb-section-title">
        # Do more with Storybook Now that you know the basics, lets explore
        other parts of Storybook that will improve your experience. This list is
        just to get you started. You can customise Storybook in many ways to fit
        your needs.
      </div>
      ...
      <div className="sb-section">
        <div className="sb-features-grid">
          ...
          <div className="sb-grid-item">
            ...
            <p className="sb-section-item-paragraph">
              Theme Storybooks UI to personalize it to your project.
            </p>
            <a
