        ...
        <div className="mx-auto grid w-full grid-cols-[250px_auto] gap-8">
          ...
          <div className="flex flex-col items-center justify-start rounded-lg p-6">
            <div className="mb-8 w-full">
              <p className="font-sans text-sm text-white">프로젝트 입력창</p>
              <div className="flex h-12 w-3/4 items-center justify-center rounded-lg bg-green-main bg-opacity-50"></div>

              <p className="mt-10 font-sans text-sm text-white">
                프로젝트 세팅할 포지션(중복가능)
              </p>

              <div className="mt-4 flex w-full max-w-2xl justify-center gap-8">
                <ChooseBox
                  title="Frontend"
