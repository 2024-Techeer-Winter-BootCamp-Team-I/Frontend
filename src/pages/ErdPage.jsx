    ...
    <Layout>
      <div className="relative flex min-h-screen w-full text-gray-200">
        <div className="flex w-full flex-col items-center justify-center">
          ...
          {/* ✨ ERD 크기 유지 + 중앙 정렬 */}
          <div className="relative flex h-[600px] w-full max-w-4xl items-center justify-center overflow-auto rounded-lg border border-gray-600 bg-gray-800 p-1 shadow-lg">
            <img
              src={SaveIcon}
              alt="Save"
          ...
          {isModalOpen && (
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-90">
              <div className="relative flex h-[95vh] w-full max-w-6xl items-center justify-center overflow-auto rounded-lg bg-gray-800">
                <button
