    ...
    <Layout>
      <div className="relative flex min-h-screen w-full text-gray-200">
        <div className="flex w-full flex-col items-center justify-center">
          ...
          {/* ✨ ERD 크기 유지 + 중앙 정렬 */}
          <div className="relative flex h-[600px] w-full max-w-4xl items-center justify-center overflow-auto rounded-lg border border-gray-600 bg-gray-800 p-0.5 shadow-lg">
            <img
              src={SaveIcon}
              alt="Save"
